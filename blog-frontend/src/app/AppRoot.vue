...
:root {
  --theme-primary: #ff2442;
  --theme-primary-light: rgba(255, 36, 66, 0.1);
  ...
  --gradient-primary: linear-gradient(135deg, #ff2442 0%, #ff6b9d 100%);
...
@keyframes pulse-glow {
  ...
  50% {
    box-shadow: 0 0 0 20px rgba(255, 36, 66, 0);
  }
}
