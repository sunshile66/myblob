...
export const userRoutes: RouteRecordRaw[] = [
  {
    path: "/login",
    name: "Login",
    component: () => import("@/pages/accounts/AuthPage.vue"),
    meta: { title: "登录" },
  },
  {
    path: "/register",
  ...
  },
  {
    ...
    name: "ForgotPassword",
    component: () => import("@/pages/accounts/ForgotPasswordPage.vue"),
    meta: { title: "忘记密码" },
  },
  {
    path: "/reset-password",
  ...
  },
  {
    path: "/profile",
    name: "Profile",
    component: () => import("@/pages/accounts/ProfilePage.vue"),
    meta: { title: "个人中心", requiresAuth: true },
  },
  {
    path: "/profile/edit",
    name: "ProfileEdit",
    component: () => import("@/pages/accounts/ProfileEditPage.vue"),
    meta: { title: "编辑个人资料", requiresAuth: true },
  },
  {
    path: "/my-posts",
    name: "MyPosts",
    component: () => import("@/pages/accounts/MyPostsPage.vue"),
    meta: { title: "我的笔记", requiresAuth: true },
  },
  {
    path: "/favorites",
    name: "Favorites",
    component: () => import("@/pages/accounts/FavoritesPage.vue"),
    meta: { title: "我的收藏", requiresAuth: true },
  },
  {
    path: "/settings/theme",
    name: "ThemeSettings",
    component: () => import("@/pages/accounts/ThemeSettings.vue"),
